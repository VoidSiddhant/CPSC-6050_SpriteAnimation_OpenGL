...
int main()
{
	...
	//Load textures
	SGTexture texAlbedo("./firesheet5x5.png");
	...
	//Attach shader object to sprite object
	sprite_fire.GetShader().AddTexture(GL_TEXTURE0, texAlbedo.GetTextureID(), "mainTex", 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		sprite_ground.GetShader().SetUniform1f("tileX", 10);
